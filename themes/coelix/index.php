...
<main id="primary" class="site-main">
   ...
   <section class="section-two">
      ...
      <div class="right-background">
         <img class="right-center" src="http://localhost/t2med/wp-content/uploads/2021/01/medic__right.png" alt="">
      </div>
      <div class="container">
         <div class="medical-info">
            ...
            <div class="medical-info__right-position">
               <div class="last">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/medic-img.png" alt="">
         ...
         <div class="section-content">
            <div class="section-content__item-1">
               <div class="item__info">
                  <div class="item__images">
                     <img class="images-1" src="http://localhost/t2med/wp-content/uploads/2021/01/3-2.png" alt="">
                  </div>
            ...
            <div class="section-content__item-2">
               <div class="item__info-2">
                  <div class="item__images">
                     <img src="http://localhost/t2med/wp-content/uploads/2021/01/1-2.png" alt="">
                  </div>
            ...
            <div class="section-content__item-3">
               <div class="item__info-3">
                  <div class="item__images">
                     <img src="http://localhost/t2med/wp-content/uploads/2021/01/2-2.png" alt="">
                  </div>
      ...
      <div class="container">
         ...
         <div class="ticket-block">
            <div class="ticket-block__figure-background">
               <div class="figure-background">
                  <img class="top-left" src="http://localhost/t2med/wp-content/uploads/2021/01/figure-topLeft.png" alt="">
               </div>
               <div class="figure-background">
                  <img class="bottom-left" src="http://localhost/t2med/wp-content/uploads/2021/01/figure-bottomLeft.png" alt="">
               </div>
               <div class="figure-background">
                  <img class="bottom-right" src="http://localhost/t2med/wp-content/uploads/2021/01/figure-bottomRight.png" alt="">
               </div>
            </div>
            <div class="content">
         ...
         <div class="team">
            <div class="team__item">
               <div class="team__item-img">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/4H3A2322-1-1.png" alt="">
               </div>
            ...
            <div class="team__item">
               <div class="team__item-img">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/Ellipse-11-2.png" alt="">
               </div>
               <div class="team__item-name">
                  <h3>Lihi Blumen</h3>
               </div>
            ...
            <div class="team__item">
               <div class="team__item-img">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/Ellipse-11-1-1.png" alt="">
               </div>
               <div class="team__item-name">
                  <h3>Omer Bachar</h3>
               </div>
   ...
   <section class="section-six">
      <div class="background-figure">
         <div class="figure__background-faq">
            <img class="top-left" src="http://localhost/t2med/wp-content/uploads/2021/01/figure-faq__top-left.png" alt="">
         </div>
         <div class="figure__background-faq">
            <img class="bottom-left" src="http://localhost/t2med/wp-content/uploads/2021/01/figure-faq__bottom-left.png" alt="">
         </div>
         <div class="figure__background-faq">
            <img class="bottom-right" src="http://localhost/t2med/wp-content/uploads/2021/01/figure-faq__bottom-right.png" alt="">
         </div>
      </div>
      <div class="container">
            ...
            <div class="faq-block__item">
               <div class="faq-block__svg">
                  <svg width="30" height="40" viewBox="0 0 30 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M4.28571 35.7895C1.92857 35.7895 0 37.6842 0 40H30C30 37.6842 28.0714 35.7895 25.7143 35.7895H17.1429V31.5789H23.5714C25.9286 31.5789 27.8571 29.6842 27.8571 27.3684H10.7143C7.15714 27.3684 4.28571 24.5474 4.28571 21.0526C4.28571 18.7579 5.55 16.7579 7.41429 15.6632C6.79286 14.8 6.42857 13.7684 6.42857 12.6316C6.42857 12.1895 6.51429 11.7474 6.62143 11.3263C4.66375 12.1243 2.9903 13.4738 1.81197 15.2047C0.633646 16.9355 0.00317132 18.9703 0 21.0526C0 26.8632 4.8 31.5789 10.7143 31.5789V35.7895H4.28571Z" fill="#032954" />
                     <path d="M11.9143 7.38947C14.8071 7.45263 17.1429 9.76842 17.1429 12.6316C17.1429 14.2105 16.4357 15.6 15.3214 16.5684L16.5857 19.9789L18.6 19.2632L19.3286 21.2421L23.3571 19.8105L22.6286 17.8316L24.6429 17.1158L18.7714 1.26316L16.7571 1.97895L16.0286 0L12 1.43158L12.7286 3.41053L10.7143 4.14737L11.9143 7.38947Z" fill="#032954" />
                     <path d="M11.7857 15.7895C13.5609 15.7895 15 14.3756 15 12.6316C15 10.8875 13.5609 9.47368 11.7857 9.47368C10.0105 9.47368 8.57143 10.8875 8.57143 12.6316C8.57143 14.3756 10.0105 15.7895 11.7857 15.7895Z" fill="#032954" />
                  </svg>
            ...
            <div class="faq-block__item">
               <div class="faq-block__svg">
                  <svg width="31" height="34" viewBox="0 0 31 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M3.44444 34H27.5556C29.4552 34 31 32.4751 31 30.6V6.8C31 4.9249 29.4552 3.4 27.5556 3.4H24.1111V0H20.6667V3.4H10.3333V0H6.88889V3.4H3.44444C1.54483 3.4 0 4.9249 0 6.8V30.6C0 32.4751 1.54483 34 3.44444 34ZM3.44444 8.5H27.5556V11.9H3.44444V8.5Z" fill="#032954" />
                  </svg>
               </div>
               <div class="faq-block__title">
            ...
            <div class="faq-block__item">
               <div class="faq-block__svg">
                  <svg width="43" height="41" viewBox="0 0 43 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M38.7 0H4.3C1.935 0 0.0215 1.84184 0.0215 4.09297L0 40.9297L8.6 32.7438H38.7C41.065 32.7438 43 30.9019 43 28.6508V4.09297C43 1.84184 41.065 0 38.7 0ZM23.65 24.5578H19.35V20.4648H23.65V24.5578ZM23.65 16.3719H19.35V8.18594H23.65V16.3719Z" fill="#032954" />
                  </svg>
               </div>
               <div class="faq-block__title">
         ...
         <div class="sponsors-ticket">
            <div class="sponsors-block">
               <div class="sponsors-block__item">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/1-1.png" alt="">
               </div>
               <div class="sponsors-block__item">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/2-1.png" alt="">
               </div>
               <div class="sponsors-block__item">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/3-1.png" alt="">
               </div>
               <div class="sponsors-block__item">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/4.png" alt="">
               </div>
               <div class="sponsors-block__item">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/5.png" alt="">
               </div>
               <div class="sponsors-block__item">
                  <img src="http://localhost/t2med/wp-content/uploads/2021/01/6.png" alt="">
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="contact-block">
            <div class="contact-block__left-position">
               <div class="contact-background">
                  <div class="top-left">
                     <img src="http://localhost/t2med/wp-content/uploads/2021/01/figure-contact__top-left.png" alt="">
                  </div>
                  <div class="bottom-left">
                     <img src="http://localhost/t2med/wp-content/uploads/2021/01/figure-contact__bottom-left.png" alt="">
                  </div>
               </div>
